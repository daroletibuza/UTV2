...
\subsection*{Gegenüberstellung der Mindestanforderungen für das Einleiten kommunaler Abwässer in einen Vorfluter der GK 5 mit den Abwasserproben}
...
\begin{table}[h!]
	\centering
	\caption{Ausschnitt aus \cite[S. 29]{Skript} zur durchschnittlichen Beschaffenheit von häuslichem Abwasser}
	\label{tab:komm}
	%\resizebox{10cm}{!}{
